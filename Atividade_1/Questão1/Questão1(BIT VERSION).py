...
'''
from Funções import Question1_lib_BIT
...
for i in range(MaskI,MaskF + 1):
    try:
        cidr = i
        AddressIpBin = Question1_lib_BIT.ip2bin(AddressIp)

       # MaskIp = Question1_lib_BIT.cidr2mascara(cidr)

       # Ipsaida = Question1_lib_BIT.bit2bitAnd(AddressIpBin[1],MaskIp[2])
